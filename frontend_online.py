...
# Backend URL
FLASK_URL = ' https://6c6d-103-53-76-210.ngrok-free.app/data-receive'
def data_backend():
    try:
...
#sidebar
st.sidebar.markdown('<h4 class="sidebar-text">NAVISI LINTASAN</h4>', unsafe_allow_html=True)
...
def hasil_foto_surface():
    file_id = "1Yzxqx5NKZz4ohBF-mc7kDYzUFYxaLK52"  # Ganti dengan ID gambar yang benar
    # URL
    ...
    if response.status_code == 200: 
        with image_placeholder.container():
            ...
            with col1:
                st.image(response.content, caption="Blue Box", use_column_width=True)
        
    else:
        st.error("Gambar tidak dapat ditampilkan.")
